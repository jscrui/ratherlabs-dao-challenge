...
let AppService = class AppService {
    constructor() {
        ...
        const provider = new ethers_1.ethers.providers.JsonRpcProvider('https://eth-sepolia.g.alchemy.com/v2/-ZhsvnJT9ky2As3D5kekbcN09cK5N2YR');
        this.contract = new ethers_1.ethers.Contract(contractAddress, abi, provider);
    }
    async getProposals() {
        const events = await this.getCreationEvents();
        let proposals = await Promise.all(events.map(async (event) => {
